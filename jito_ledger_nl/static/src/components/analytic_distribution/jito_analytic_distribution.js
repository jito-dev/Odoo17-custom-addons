...
export class JitoAnalyticDistribution extends Component {
    static template = "jito_ledger_nl.JitoAnalyticDistribution";
    static components = {
        TagsList,
        Record,
        Field,
    ...
    setup(){
        ...
        this.openTemplate = useOpenMany2XRecord({
            resModel: "jito.ledger.analytic.distribution.model",
            activeActions: {
                create: true,
                edit: false,
                write: true,
    ...
    recordProps(line) {
        ...
        line.analyticAccounts.map((account) => {
            ...
            recordFields[fieldName] = {
                ...
                relation: "jito.ledger.analytic.account",
                type: "many2one",
                related: {
    ...
    async fetchAllPlans(props) {
        ...
        this.allPlans = await this.orm.call("jito.ledger.analytic.plan", "get_relevant_plans", [], argsPlan);
    }
    ...
    async fetchAnalyticAccounts(domain) {
        ...
        // batched call
        const records = await this.batchedOrm.read("jito.ledger.analytic.account", domain[0][2], args.fields, {});
...
export const jitoAnalyticDistribution = {
    component: JitoAnalyticDistribution,
...
registry.category("fields").add("jito_analytic_distribution", jitoAnalyticDistribution);
