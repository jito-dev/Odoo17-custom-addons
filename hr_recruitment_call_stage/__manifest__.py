...
""",
    ...
    'data': [
        ...
        'views/call_stage_preview_views.xml',
    ...
    'assets': {
        'web.assets_frontend': [
            'hr_recruitment_call_stage/static/src/scss/appointment_call_stage.scss',
            'hr_recruitment_call_stage/static/src/js/appointment_validation_confirm.js',
        ],
        'web.assets_backend': [
            ...
            'hr_recruitment_call_stage/static/src/js/call_stage_availability.js',
            'hr_recruitment_call_stage/static/src/xml/call_stage_availability.xml',
        ],
    },
    'installable': True,
    'application': False,
