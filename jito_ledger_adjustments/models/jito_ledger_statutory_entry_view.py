...
class JitoLedgerStatutoryEntryView(models.Model):
    ...
    from a stock entry to the Restatements / Regroupings that were
    generated from its lines.

    Lives in jito_ledger_adjustments because it references the Phase 4
    wizard models. The base SQL-view model is in jito_ledger_nl.
    """
