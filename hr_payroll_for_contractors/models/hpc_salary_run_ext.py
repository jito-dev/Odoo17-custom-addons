...
class HpcSalaryRunExt(models.Model):
    ...
    def action_delete_contractor_invoice(self):
        """Delete all linked contractor invoices and clear the uploaded invoice file."""
        self.ensure_one()
        self.contractor_invoice_ids.unlink()
        self.write({
            'contractor_invoice_file': False,
            'contractor_invoice_filename': False,
        })
